...
CSL.Output.Formats.prototype.html = {
    ...
    "bibstart": function(state, str) {
        return "<div class=\"csl-bib-body\">\n";
    },
    "bibend": function(state, str) {
        return "</div>";
    },
    ...
    "@font-style/normal": function(state, str) {
        return "<span style=\"font-style:normal;\">" + str + "</span>";
    },
    ...
    "@font-variant/normal": function(state, str) {
        return "<span style=\"font-variant:normal;\">" + str + "</span>";
    },
    ...
    "@text-decoration/none": function(state, str) {
        return "<span style=\"text-decoration:none;\">" + str + "</span>";
    },
    ...
    "@vertical-align/baseline": function(state, str) {
        return "<span style=\"baseline\">" + str + "</span>";
    },
